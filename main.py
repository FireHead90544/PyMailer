...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.usesslRadioButton.setGeometry(QRect(1130, 30, 121, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fromLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Your Name", None))
...
if __name__ == "__main__":
    ...
    apply_stylesheet(app, 'theme_darkred.xml') # Applying the stylesheet for epic looks :)
